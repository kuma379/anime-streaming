    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-[hsl(222,47%,5%)/95] backdrop-blur-md border-b border-purple-900/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-3">
            <div className="hidden sm:flex items-center gap-2 bg-[hsl(222,47%,12%)] rounded-full px-4 py-2 w-48 lg:w-64">
      ...
      {isOpen && (
        <div className="md:hidden bg-[hsl(222,47%,8%)] border-t border-purple-900/30 px-4 py-4 flex flex-col gap-4">
          <div className="flex items-center gap-2 bg-[hsl(222,47%,12%)] rounded-full px-4 py-2">
          ...
          {links.map((link) => (
            <Link
              ...
              className={`text-sm font-medium ${
                location === link.href ? "text-purple-400" : "text-gray-300"
              }`}
